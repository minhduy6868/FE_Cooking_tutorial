<template>
  <div class="bg-white text-black dark:bg-black dark:text-white">
    <div class="container mx-auto px-4 py-8">
      <p class="mb-4">Effective Date: 2024-7-15</p>
      ...
      <p class="mb-4 text-base">
        ...
        website. By using the website, you agree to be bound by these terms of service. If you do
        not agree to these terms of service, you may not use the website. These terms of service
        govern your use of the website and all services provided by the website. If you do not agree
        to these terms of service, you may not use the website.
      </p>
      <br />
        ...
        <ul>
          ...
          <li class="list-disc">
            <p class="text-base">
              ...
              terms of service. Any updates you will be notified via email.
            </p>
          </li>
        </ul>
      </div>
      <div class="w-full flex">
        <h1 class="text-3xl font-bold mb-4 text-orange-800">
          Thông tin liên hệ với kĩ thuật viên:
        </h1>
      </div>
    </div>
  </div>
