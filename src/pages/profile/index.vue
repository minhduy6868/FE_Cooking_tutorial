        ...
        <div class="flex flex-col">
            ...
            <div class="relative w-full">
                <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw5fHxjb3ZlcnxlbnwwfDB8fHwxNzEwNzQxNzY0fDA&ixlib=rb-4.0.3&q=80&w=1080"
                    alt="User Cover" class="w-full xl:h-[20rem] lg:h-[18rem] md:h-[16rem] sm:h-[14rem] xs:h-[11rem] object-cover" />

                <!-- Profile Image and Name -->
                <div class="absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                    <div class="w-[141px] h-[141px] rounded-full bg-[url('https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw3fHxwZW9wbGV8ZW58MHwwfHx8MTcxMTExMTM4N3ww&ixlib=rb-4.0.3&q=80&w=1080')] bg-cover bg-center bg-no-repeat flex justify-center items-end relative">

                        <input type="file" name="profile" id="upload_profile" hidden required>
                        <label for="upload_profile" class="bg-white rounded-full w-6 h-6 text-center absolute bottom-0 right-0 transform translate-x-1/4 translate-y-1/4 flex items-center justify-center cursor-pointer">
                    ...
                    <h1 class="mx-5 my-4 text-gray-800 dark:text-white lg:text-4xl md:text-3xl sm:text-3xl xs:text-xl font-serif text-center">
                        Samuel Abera
                    </h1>
                </div>
            </div>
            ...
            <div class="xl:w-[80%] lg:w-[90%] md:w-[90%] sm:w-[92%] xs:w-[90%] mx-auto flex flex-col gap-6 items-center my-6 mt-24">
                <p class="text-center w-fit text-gray-700 dark:text-gray-400 text-md">
                    ...
                    explicabo, eligendi odit, dolore similique fugiat dolor, doloremque eveniet.
                </p>
