<template>
  <div class="infor">
    <div
      class="px-4 pb-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8"
    >
      <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div class="sm:col-span-2">
          ...
          <div class="mt-1 lg:max-w-sm">
            <router-link to="/loginadmin">
              <a
                href=""
                class="inline-flex items-center justify-center p-2 text-base font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-white hover:bg-orange-500 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                <svg
                  class="w-4 h-4 mr-3"
            ...
            <p class="text-sm text-gray-800">
              Khám phá công thức món ăn đa dạng và dễ làm, cùng mẹo nấu nướng tại website của chúng
              tôi!
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <p class="text-sm text-gray-500">
            Nếu bạn có bất kì thắc mắc, hoặc phát hiện lỗi của trang web chúng tôi, vui lòng nhấn
            vào
            <a
              href="#"
              class="text-deep-purple-accent-400 hover:underline text-orange-500"
